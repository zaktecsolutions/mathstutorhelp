<div class="form-group row">
    ...
    <div class="col-md-8">
        <input id="lesson_name" type="lesson_name" class="form-control @error('lesson_name') is-invalid @enderror"
            name="lesson_name" value="{{$lesson->lesson_name ??  old('lesson_name')  }}" required autocomplete="lesson_name" autofocus>
        @error('lesson_name')
...
<div class="form-group row">
    ...
    <div class="col-md-8">
        <input id="lesson_code" type="text" class="form-control @error('lesson_code') is-invalid @enderror"
            name="lesson_code" value=" {{ $lesson->lesson_code ??  old('lesson_code') }} " required autocomplete="lesson_code" autofocus>
        @error('lesson_code')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
...
<div class="form-group row">
    ...
    <div class="col-md-8">
        <input id="lesson_desc" type="text" class="form-control @error('lesson_desc') is-invalid @enderror"
            name="lesson_desc" value="{{ $lesson->lesson_desc ??  old('lesson_desc') }}" required autofocus>
        @error('lesson_desc')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input id="lesson_ws" type="text" class="form-control @error('lesson_ws') is-invalid @enderror"
            name="lesson_ws" value="{{ $lesson->lesson_ws ??  old('lesson_ws')  }}" required autofocus>
        @error('lesson_ws')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input id="lesson_body" type="text" class="form-control @error('lesson_body') is-invalid @enderror"
            name="lesson_body" value="{{ $lesson->lesson_body ??  old('lesson_body')   }}" required autofocus>
        @error('lesson_body')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
